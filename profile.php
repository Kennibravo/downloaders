...
$userProfileData = get('id,username,email,password', 'users', 'id', $id);
...
<br><br>
<?php if($id == $userId){ ?>
	<a class="waves-effect waves-light btn" href="edit-profile.php?id=<?php echo $userId ; ?>""><i class="material-icons left"></i>Edit Profile</a>
<?php } ?>
<div class="row">
